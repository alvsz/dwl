...
static struct wl_listener end_swipe = {.notify = swipe_end};
static struct wl_listener begin_pinch = {.notify = pinch_begin};
static struct wl_listener update_pinch = {.notify = pinch_update};
static struct wl_listener end_pinch = {.notify = pinch_end};
static struct wl_listener begin_hold = {.notify = hold_begin};
static struct wl_listener end_hold = {.notify = hold_end};
...
void setup(void) {
  ...
  wl_signal_add(&cursor->events.swipe_begin, &begin_swipe);
  wl_signal_add(&cursor->events.swipe_update, &update_swipe);
  wl_signal_add(&cursor->events.swipe_end, &end_swipe);
  wl_signal_add(&cursor->events.pinch_begin, &begin_pinch);
  wl_signal_add(&cursor->events.pinch_update, &update_pinch);
  wl_signal_add(&cursor->events.pinch_end, &end_pinch);
  wl_signal_add(&cursor->events.hold_begin, &begin_hold);
  wl_signal_add(&cursor->events.hold_end, &end_hold);
