...
all: dwl
dwl: dwl.o util.o dwl-ipc-unstable-v2-server-protocol.o
...
dwl-ipc-unstable-v2-server-protocol.o: dwl-ipc-unstable-v2-protocol.c dwl-ipc-unstable-v2-server-protocol.h
